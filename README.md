...
[![Linux](https://img.shields.io/circleci/project/github/conda-forge/r-conflicted-feedstock/master.svg?label=Linux)](https://circleci.com/gh/conda-forge/r-conflicted-feedstock)
[![OSX](https://img.shields.io/travis/conda-forge/r-conflicted-feedstock/master.svg?label=macOS)](https://travis-ci.org/conda-forge/r-conflicted-feedstock)
[![Windows](https://img.shields.io/appveyor/ci/conda-forge/r-conflicted-feedstock/master.svg?label=Windows)](https://ci.appveyor.com/project/conda-forge/r-conflicted-feedstock/branch/master)
...
Once the `conda-forge` channel has been enabled, `r-conflicted` can be installed with:

```
conda install r-conflicted
```

It is possible to list all of the versions of `r-conflicted` available on your platform with:
